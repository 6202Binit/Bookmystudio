      ...
      <div className="flex">
        <div className="w-[18vw] shadow-xl rounded-lg mt-10">
          <div className="ml-4">
            ...
            <button
              className={`mb-6  w-full sm:w-[12rem] ${
                isOpen
                  ? " bg-blue-500 py-2 pr-4 rounded-lg text-white "
                  : "text-slate-400"
              }`}
            ...
            <button className="mt-8 text-slate-400 flex w-full sm:w-[12rem]">
        ...
        <div className=" w-[82vw]">
          <div className="flex mt-3 mx-3 py-1">
            <img className="w-5 h-5 mt-1" src={backarrow} alt="" />
